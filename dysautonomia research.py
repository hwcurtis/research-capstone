...
Dysautonomia happens unpredictably and for reasons experts do not yet understand. It is not possible to prevent it or lower your risk of having it.
Living With
...
What can or can not eat or drink with dysautonomia?
Your healthcare provider will likely recommend certain changes to what you eat and drink if you have dysautonomia. The recommendations often include(but are not limited to):
Avoid alcohol.
Stay hydrated.
...
Chest pain.
Trouble breathing.
Heartbeat that is unusually slow, racing, pounding or that you aree unpleasantly aware of without trying to feel it (heart palpitations).
...
Dysautonomia can have triggers that make symptoms happen suddenly or worsen. Knowing and tracking your triggers (especially with a journal or diary) can help you learn and avoid them. Common triggers can include (but aren’t limited to):
Drinking alcohol.
Dehydration.
Stress.
